...
import '../domain/usecase/delete_multiple_notes.dart' as _i17;
import '../domain/usecase/delete_note_usecase.dart' as _i18;
import '../domain/usecase/get_note_usecase.dart' as _i19;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i17.DeleteMultipleNotesUsecase>(
      () => _i17.DeleteMultipleNotesUsecase(get<_i12.NoteRepository>()));
  gh.factory<_i18.DeleteNoteUsecase>(
      () => _i18.DeleteNoteUsecase(get<_i12.NoteRepository>()));
  gh.factory<_i19.GetNoteUsecase>(
      () => _i19.GetNoteUsecase(get<_i12.NoteRepository>()));
  gh.factory<_i20.MultipleDeleteBloc>(
      () => _i20.MultipleDeleteBloc(get<_i17.DeleteMultipleNotesUsecase>()));
  return get;
}
